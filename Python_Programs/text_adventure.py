start =('''When you wake up do you ever consider how harmful your dicisions are to the enviroment when it comes to simple
...
if user_input == 'plastic':
    ...
    if user_input == 'glass':
        user_input = input('good job you have done it again')
